...
def writer_suffix() -> str:
    """Output-file suffix identifying who wrote a DXF. Two writers share these scripts (Claude: "_claude",
    Antigravity: "_ag"); set PLAT_DXF_SUFFIX to choose. Default "_claude"."""
    import os
    return os.environ.get("PLAT_DXF_SUFFIX", "_claude")
